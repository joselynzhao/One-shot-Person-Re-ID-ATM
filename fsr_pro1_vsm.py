#!/usr/bin/python3.6
# -*- coding: utf-8 -*-
# @Time    : 2020/9/1 下午7:55
# @Author  : Joselynzhao
# @Email   : zhaojing17@forxmail.com
# @File    : fsr_pro1_vsm.py
# @Software: PyCharm
# @Desc    :

#!/usr/bin/python3.6
# -*- coding: utf-8 -*-
# @Time    : 2020/9/1 下午3:39
# @Author  : Joselynzhao
# @Email   : zhaojing17@forxmail.com
# @File    : fsr_pro1.py
# @Software: PyCharm
...
def main(args):
    ...
    for step in range(total_step):
        ...
        if iter_mode==2:
            ...
            selected_idx = eug.select_top_data_vsm(pred_score, dists,args.topk,vsm_lambda,min(nums_to_select, len(u_data)))
